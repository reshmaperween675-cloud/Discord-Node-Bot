...
__export(schema_exports, {
  activityTrackerTable: () => activityTrackerTable,
  antiNukeConfigTable: () => antiNukeConfigTable,
  antiNukeWhitelistTable: () => antiNukeWhitelistTable,
  attendancesTable: () => attendancesTable,
  authBackupsTable: () => authBackupsTable,
  botKvTable: () => botKvTable,
  botSequencesTable: () => botSequencesTable,
  censorGuildConfigTable: () => censorGuildConfigTable,
  censorUserFlagsTable: () => censorUserFlagsTable,
  dashboardAuditLogsTable: () => dashboardAuditLogsTable,
  economyUsersTable: () => economyUsersTable,
  insertActivitySchema: () => insertActivitySchema,
  insertAuthBackupSchema: () => insertAuthBackupSchema,
  insertBotKvSchema: () => insertBotKvSchema,
  insertDashboardAuditLogSchema: () => insertDashboardAuditLogSchema,
  killLeaderboardPlayersTable: () => killLeaderboardPlayersTable,
  killPinnedMessagesTable: () => killPinnedMessagesTable,
  leaderboardPinnedMessagesTable: () => leaderboardPinnedMessagesTable,
  leaderboardPlayersTable: () => leaderboardPlayersTable,
  lowoEmojiOverridesTable: () => lowoEmojiOverridesTable,
  lowoGuildSettingsTable: () => lowoGuildSettingsTable,
  mewoAiUsageTable: () => mewoAiUsageTable,
  mewoEmbedColorsTable: () => mewoEmbedColorsTable,
  mewoEnabledChannelsTable: () => mewoEnabledChannelsTable,
  mewoTagsTable: () => mewoTagsTable,
  mewoTimezonesTable: () => mewoTimezonesTable,
  mewoWalletsTable: () => mewoWalletsTable,
  mvpsTable: () => mvpsTable,
  promotionsTable: () => promotionsTable,
  raidResultsTable: () => raidResultsTable,
  rulesMessagesTable: () => rulesMessagesTable,
  selectActivitySchema: () => selectActivitySchema,
  selectAuthBackupSchema: () => selectAuthBackupSchema,
  selectBotKvSchema: () => selectBotKvSchema,
  selectDashboardAuditLogSchema: () => selectDashboardAuditLogSchema,
  tournamentParticipantsTable: () => tournamentParticipantsTable,
  tournamentsTable: () => tournamentsTable,
  trainingLogsTable: () => trainingLogsTable,
